...
<%@ page import="com.ashish.dao.*, com.ashish.service.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	int notf = new CartDao().getCartCount((String) session.getAttribute("username"));
	%>
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					%>
					<li><a href="cartDetails.jsp"><i
							class="glyphicon glyphicon-shopping-cart"></i> <i
							class="cart-icon "><%=notf%> </i></a></li>
					<%
					}
					%>
