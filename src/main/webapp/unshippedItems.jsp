...
<%@ page
	import="com.ashish.dao.*, com.ashish.model.*,com.ashish.service.*,java.util.*"%>
<!DOCTYPE html >
<html>
<head>
			...
			<table class="table table-hover table-sm">
				...
				<tbody style="background-color: white;">
					...
					for (OrderModel order : orders) {
						...
						String userId = new TransDao().getUserId(transId);
						String userAddr = new UserDao().getUserAddr(userId);
						if (shipped == 0) {
							count++;
					%>
